"""tappables_17530 URL Configuration
...
admin.site.site_header = "tappables"
admin.site.site_title = "tappables Admin Portal"
admin.site.index_title = "tappables Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="tappables API",
        default_version="v1",
        description="API documentation for tappables App",
    ),
    public=True,
